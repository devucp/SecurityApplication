            ...
            public void onClick(View view) {
                ...
                if (!empty_mobile) {
                    if (!inputValidation.valid_input(input_mobile, 10, getString(R.string.no_phone))) {
                        if (inputValidation.is_Valid(input_mobile)) {
                ...
                if (!empty_aadhar) {
                    if (!inputValidation.valid_input(input_aadhar, 12, getString(R.string.no_aadhar))) {
                        if (inputValidation.is_Valid(input_aadhar)) {
